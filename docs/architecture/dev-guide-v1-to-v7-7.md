...
| **Observed Patterns Catalog** | [`.claude/integrity/observed-patterns.md`](../../.claude/integrity/observed-patterns.md) (v7.8.5). The canonical manifest of gate-firing patterns — 23 gate patterns + 29 workflow (W1–W29). When a gate fires, consult it FIRST (§10.5). `make observed-patterns`. |
...
- **Coverage (current):** 23 gate-firing patterns (Section 1, `#1`–`#23`) + 29 workflow/operational patterns (Section 2, `W1`–`W29`).
