...
- [ ] Push notifications — **rebuild from scratch** in progress (full PM cycle restarted 2026-05-07 after v7.7 freeze + v1 partial-ship audit; `current_phase=research`), Linear `FIT-23`. State at `.claude/features/push-notifications/`. v1 artifacts archived at `.claude/features/push-notifications/_v1/`.
