...
| B12 | **2026-05-27** | UCC hardening T+7d kill-criteria evaluation — populate `kill_criteria_resolution` in case study §4 + frontmatter; decide PROMOTE / RECALIBRATE / ROLLBACK. **T-2 prep done 2026-05-25:** case study §4 now carries structured query templates + verdict decision matrix; estimated 30-min mechanical execution on the day. | operator | [`docs/case-studies/ucc-passkey-auth-security-hardening-case-study.md`](../../docs/case-studies/ucc-passkey-auth-security-hardening-case-study.md) §4 + §99 |
