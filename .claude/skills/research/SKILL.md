...
1. Read `.claude/cache/research/_index.json` for L1 entries
...
2. Write or update L1 cache entry in `.claude/cache/research/`
...
2. Competitor feature matrices
3. UX pattern libraries (Mobbin, Pttrns)
4. Academic/industry sources
